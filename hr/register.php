      ...
      <!-- Example row of columns -->
				...
				<div class="form-group">
				  ...
				  <input id="username" name="username" placeholder="Korisničko ime" class="form-control input-md" required="" type="text">
								...
								<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="ime_prezime">Ime i prezime</label>  
				  <div class="col-md-4">
				  <input id="ime_prezime" name="ime_prezime" placeholder="Ime i prezime" class="form-control input-md" required="" type="text">
								...
								<div class="form-group">
				  <label class="col-md-4 control-label" for="broj_telefona">Broj telefona</label>  
				  <div class="col-md-4">
				...
				<!-- Password input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="lozinka_opet">Ponovite lozinku</label>
				  <div class="col-md-4">
