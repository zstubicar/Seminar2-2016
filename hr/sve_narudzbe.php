...
?>
    ...
    <div class="container">
      <!-- Example row of columns -->
      	<h2>Lista narudžbi svih korisnika</h2>
		...
		<h2>Lista izvršenih narudžbi svih korisnika</h2>
		<table class="table table-bordered table-stripped">
			<tr class="text-center">
				<td>ID</td>
				<td>Ime korisnika</td>
		...
		<h4 class="text-center">Ukupna zarada od svih transakcija: <b><?php echo $ukupna_cijena; ?></b> KN</h4>
