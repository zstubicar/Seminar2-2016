...
?>
    ...
    <div class="container">
      <!-- Example row of columns -->
		<h1>Stuff delivery</h1>

			<form class="form-horizontal" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">

				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="mjesto">Place</label>  
				  <div class="col-md-4">
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" for="vrijeme">Time of delivery (8 - 20h)</label>  
					<div class="col-md-4 control-label">
						 <select name="vrijeme" class="form-control input-md">
						 <option value="-"></option>
						 <?php
						 	for($i = 8; $i <= 20; $i++){
						 		echo "<option value='".$i."'>u ".$i." h</option>";
						 	}
						 ?>
						</select>
				  	  </div>
				...
				<div class="form-group">
					  <label class="col-md-4 control-label" for="placanje">Paying</label>  
					<div class="col-md-4 control-label">  
						 <label class="radio-inline"><input type="radio" name="placanje" checked="true" value="pouzece">Payment on delivery</label>
					</div>
				</div>

				<div class="form-group">
					<label class="col-md-4 control-label" for="stvari">Stuff for delivery</label>  
					<div class="col-md-4 control-label">  
						<?php
